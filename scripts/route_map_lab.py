...
from run_router.service import (
    ...
    PlanningRequest,
    PRIORITY_OPTIONS,
    REPEAT_PREFERENCE_OPTIONS,
    ROUTE_PATTERN_OPTIONS,
...
PLAN_PRESETS = {
    "safe-early-morning": {
        ...
        "max_distance_from_start_miles": 1.0,
    ...
    "easy-nearby-loop": {
        ...
        "max_distance_from_start_miles": 1.2,
        "route_pattern_preference": "loop",
        "repeat_preference": "none",
    ...
    "city-landmark-run": {
        ...
        "max_distance_from_start_miles": 2.5,
        "route_pattern_preference": "either",
        "repeat_preference": "none",
    ...
    "race-prep-hills": {
        ...
        "max_distance_from_start_miles": 2.0,
        "route_pattern_preference": "either",
    ...
    "trail-confidence-loop": {
        ...
        "distance_tolerance_miles": 0.6,
        "start_radius_miles": 0.5,
        "max_distance_from_start_miles": 1.75,
        "route_pattern_preference": "loop",
        "repeat_preference": "none",
        ...
        "candidates": [
            {
                ...
                "poi_summary": candidate.route.poi_summary,
        ...
        if self.path == "/api/plans":
            self._send_json(
                200,
                {
                    ...
                    "route_patterns": ROUTE_PATTERN_OPTIONS,
                    "repeat_preferences": REPEAT_PREFERENCE_OPTIONS,
